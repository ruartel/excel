...
$cols_result = DB::query('SHOW COLUMNS FROM institute_files');
$x='A';
$colsName = array();
...
$row=2;
$result = DB::query('SELECT * FROM institute_files');
...
//header('Content-Disposition: attachment;filename="matan4.xls"');
